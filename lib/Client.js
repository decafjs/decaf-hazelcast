...
var File = require ('File'),
    ClientConfig = Packages.com.hazelcast.client.config.ClientConfig,
    HazelcastClient = Packages.com.hazelcast.client.HazelcastClient;
...
function Client(configFilePath) {
    ...
    this.hazelcastInstance = HazelcastClient.newHazelcastClient(new ClientConfig());
}
